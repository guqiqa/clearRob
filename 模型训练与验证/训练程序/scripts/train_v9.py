def main():
    ...
    print("=" * 60)
    print("  V9 CrASh-SAFE — YOLOv11s, 8 classes, Mosaic=0.3")
    print("  40,764 images / 44,054 boxes")
    print("  Real detection: 78% / Full-img supplement: 22%")
    print("  TACO + self-collected included")
    print("=" * 60)
