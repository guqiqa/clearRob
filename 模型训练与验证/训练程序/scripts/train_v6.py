def main():
    ...
    print("=" * 60)
    print("  V6 — YOLOv11s, 7 classes, Mosaic=0.0")
    print("  29,759 images / 50,674 boxes")
    print("  Real-time logging to epoch_metrics.jsonl + training_summary.txt")
    print("=" * 60)

    model = YOLO("yolo11s.pt")

    # Register callback before .train()
