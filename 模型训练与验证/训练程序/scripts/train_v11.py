def main():
    ...
    data_yaml = r"d:\AIview\模型训练与验证\训练程序\configs\dataset_v11.yaml"
    ...
    print("=" * 60)
    print("  V12 — YOLOv11s, 8 classes, Mosaic=0.8")
    print("  40,053 images / 46,052 boxes")
    print("  Full-img: 25.6%, annotated Garbages 3,817 real boxes")
    print("  fliplr=1.0, hsv↑, scale=0.9")
    print("=" * 60)
