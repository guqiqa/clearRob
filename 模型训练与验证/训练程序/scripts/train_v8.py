def main():
    ...
    data_yaml = r"d:\AIview\模型训练与验证\训练程序\configs\dataset_v8.yaml"
    ...
    print("=" * 60)
    print("  V8 — YOLOv11s, 8 classes, Mosaic=0.0")
    print("  91,541 images / 79,162 boxes")
    print("  9 data sources (all except TACO)")
    print("  Full-img ratio: 71% — CRASH RISK HIGH")
    print("=" * 60)
