def main():
    ...
    data_yaml = r"d:\AIview\模型训练与验证\训练程序\configs\dataset_v12.yaml"
    ...
    print("=" * 60)
    print("  V12 — YOLOv11s + garbages_annotated + trainval_voc")
    print("  Full-img ~25.6%, Mosaic=0.8, fliplr=1.0")
    print("  HSV↑, RandAugment, warmup=10")
    print("=" * 60)
